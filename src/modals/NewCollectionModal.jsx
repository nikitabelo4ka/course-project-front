...
const NewCollectionModal = ({show, onHide, userId, info, isModify}) => {
    ...
    useEffect(() => {
        fetchCollections().then((data) => collection.setCollections(data)).then(() => {
            if(isModify) {
                fetchOneCollection(info.id).then((data) => {
                    ...
                    setIsCheckboxActive((state) => ({...state, integer: [data.integerField1, data.integerField2, data.integerField3].filter(item => item).length > 0}));
                    setIsCheckboxActive((state) => ({...state, text: [data.textField1, data.textField2, data.textField3].filter(item => item).length > 0}));
                    setIsCheckboxActive((state) => ({...state, string: [data.stringField1, data.stringField2, data.stringField3].filter(item => item).length > 0}));
                    setIsCheckboxActive((state) => ({...state, date: [data.dateField1, data.dateField2, data.dateField3].filter(item => item).length > 0}));
                    setIsCheckboxActive((state) => ({...state, bool: [data.boolField1, data.boolField2, data.boolField3].filter(item => item).length > 0}));
                    ...
                    setIsCheckboxChecked((state) => ({...state, integer: {...state.integer, first: Boolean(data.integerField1)}}));
                    setIsCheckboxChecked((state) => ({...state, integer: {...state.integer, second: Boolean(data.integerField2)}}));
                    setIsCheckboxChecked((state) => ({...state, integer: {...state.integer, third: Boolean(data.integerField3)}}));
                    ...
                    setIsCheckboxChecked((state) => ({...state, string: {...state.string, first: Boolean(data.stringField1)}}));
                    setIsCheckboxChecked((state) => ({...state, string: {...state.string, second: Boolean(data.stringField2)}}));
                    setIsCheckboxChecked((state) => ({...state, string: {...state.string, third: Boolean(data.stringField3)}}));
    ...
    const addCollection = () => {
        if(isModify) {
            ...
            createCollection(name, theme === "Other" ? otherTheme : theme, images, description, JSON.stringify([...Object.values(customFieldsValue.integer), ...Object.values(customFieldsValue.text), ...Object.values(customFieldsValue.string), ...Object.values(customFieldsValue.date), ...Object.values(customFieldsValue.bool)]), userId === undefined ? token.id : userId).then((data) => {
                onHide();
            });
        }
    };
        ...
        <Modal show={show} onHide={onHide} centered>
            ...
            <Modal.Body>
                <Form className="d-flex flex-column">
                    ...
                    <Form.Check checked={isCheckboxActive.integer} onChange={(e) => checkboxChange(e, 'integer')} type="switch" id="custom-switch" label="Integer fields"/>
                    ...
                    <Form.Check checked={isCheckboxActive.text} onChange={(e) => checkboxChange(e, 'text')} type="switch" id="custom-switch" label="Text fields"/>
                    ...
                    <Form.Check checked={isCheckboxActive.string} onChange={(e) => checkboxChange(e, 'string')} type="switch" id="custom-switch" label="String fields"/>
                    ...
                    <Form.Check checked={isCheckboxActive.date} onChange={(e) => checkboxChange(e, 'date')} type="switch" id="custom-switch" label="Date fields"/>
                    ...
                    <Form.Check checked={isCheckboxActive.bool} onChange={(e) => checkboxChange(e, 'bool')} type="switch" id="custom-switch" label="Yes/No fields"/>
