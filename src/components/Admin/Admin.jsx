      ...
      <tbody>
        {user.users.map((item) => (
          <tr key={item.id}>
            ...
            <td className="d-md-none">
              <Dropdown>
                ...
                <Dropdown.Menu>
                  ...
                  <Dropdown.Item className="admin-btn" onClick={() => ChangeAdmin(item.id, item.role)}>
                    {item.role === 'ADMIN' ? 'Delete ADMIN' : 'Set ADMIN'}
                  </Dropdown.Item>
                  <Dropdown.Item className="admin-btn" onClick={() => Delete(item.id)}>
                    Delete user
                  </Dropdown.Item>
                  <Dropdown.Item className="admin-btn" onClick={() => history(USER_COLLECTIONS_ROUTE + '/' + item.id)}>
                    Collections
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            ...
            <td className="d-none d-md-table-cell">
              <Button
                variant={item.role === 'ADMIN' ? 'danger' : 'success'}
                onClick={() => ChangeAdmin(item.id, item.role)}
                className="admin-btn"
              >
                {item.role === 'ADMIN' ? 'Delete ADMIN' : 'Set ADMIN'}
              </Button>
            ...
            <td className="d-none d-md-table-cell">
              <Button
                variant="info"
                onClick={() => history(USER_COLLECTIONS_ROUTE + '/' + item.id)}
                className="admin-btn"
              >
                Collections
              </Button>
