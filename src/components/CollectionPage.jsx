                    ...
                    <ThemeProvider theme={tableTheme}>
                        <MaterialReactTable
                            ...
                            renderRowActionMenuItems={({ row }) => [
                                <div className={token === null || token.id !== item.userId ? (token && token.role === "ADMIN" ? "table-action-button" : "d-none") : "table-action-button"} key="edit" onClick={() => {setModalVisible(true); setIsModify(true); setCollectionItemId(collectionItems.collectionItems[row.index].id)}}>
                                    Edit
                                </div>,
                                <div className={token === null || token.id !== item.userId ? (token && token.role === "ADMIN" ? "table-action-button" : "d-none") : "table-action-button"} key="delete" onClick={() => {deleteCollectionItem(collectionItems.collectionItems[row.index].id); setShouldUpdate((state) => !state)}}>
                                    Delete
                                </div>,
